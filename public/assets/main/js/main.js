  ...
  var invJs = {
    ...
    autoslidertab: function () {
      ...
      $(document).ready(function () {
        function tabChange() {
          ...
          var active = $(
            ".progress-tabs-activation .nav-tabs .nav-link.active"
          );
    ...
    portfoliobounceAnimation: function () {
      if (device_width > 991) {
        // each wrapper loop
        document
          .querySelectorAll(".tmp_jump_animation-wrapper")
          .forEach((wrapper) => {
    ...
    slickSliderActivation: function () {
      ...
      $(".inner-demo-carousel-activation")
        .not(".slick-initialized")
        .slick({
          infinite: true,
          slidesToShow: 3,
    ...
    gsapAnimationImageScale: function (e) {
      ...
      $(document).ready(function () {
        let growActive = document.getElementsByClassName(
          "grow-thumbnail-1-overlay"
        );
        if (growActive.length) {
          const growTmp = gsap.timeline({
            scrollTrigger: {
    ...
    scrollingText: function () {
      $(document).ready(function () {
        let scrollingTextTwo =
          document.getElementsByClassName("scrollingtext-1");
    ...
    imageSlideGsap: function () {
      $(document).ready(function () {
        let image_leftright = document.querySelectorAll(
