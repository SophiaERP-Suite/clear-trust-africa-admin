  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="mb-6 ">
          <label className="block mb-2 text-black">Select Role</label>
          <select
        ...
        <div className="mb-6">
          <label className="block mb-2 text-black">Select Permission</label>
          <select
        ...
        {!loading && !error && rolePermissions.length > 0 && (
          <ul className="space-y-3 mt-6">
            {rolePermissions.map((rolePermission) => (
              ...
              >
                <span>
                  <b>Role:</b> {rolePermission.roleName} <br /> <b>Permission:</b>{" "}
                ...
                <div>
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      openDeleteModal(rolePermission.rolePermissionId)
                    }
                  >
                    <Trash2Icon size={16} />
                  </button>
