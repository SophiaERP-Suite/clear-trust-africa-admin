...
// import { createAuditTrail } from "../../../api/auditTrailApi";
// import { GeolocationService, type PositionData } from "../service/geoLocation";

// type ModalType = "add" | "edit" | "delete" | null;

// function StatesManagement(params: CreateAuditTrailParams): Promise<any> {
...
//    const { auditData, useGeolocation = true, address = {} } = params;

//   let location: PositionData = { latitude: null, longitude: null };

//   if (useGeolocation) {
//     location = await GeolocationService.getPositionSafely();
//   }
...
//         action: "",
//         description: "User created a new state",
//         isNotification: true,
...
//       await createAuditTrail(auditPayload);
//       notifySuccess();
//       closeModal();
