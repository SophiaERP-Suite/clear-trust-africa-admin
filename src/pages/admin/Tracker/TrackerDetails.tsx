...
export default function TrackerDetails() {
  ...
  const { register, handleSubmit, formState } = useForm<AdminFormValues>();
                  ...
                  <div className="flex flex-wrap items-center justify-between">
                    ...
                    <ul className="flex flex-wrap mb-0 text-center items-start">
                      <li className="nav-item gap-2 relative">
                        ...
                        {openMoreAction && (<div className="absolute top-8 right-1 mt-2 w-55 bg-white border shadow-lg z-1">
                            { user?.userId }
                          <button className="block w-full px-4 py-2 hover:bg-secondary-200 text-left text-black">
                            <UserStar size={18} className="mr-2" /> Assign To Staff
                          </button>
